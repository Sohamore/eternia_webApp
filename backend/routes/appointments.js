...
router.get('/earnings', authenticate, requireRole('expert'), ctrl.getExpertEarnings);
router.get('/', authenticate, ctrl.getMyAppointments);
router.get('/:id', authenticate, ctrl.getAppointmentById);
router.patch('/:id/confirm', authenticate, requireRole('expert'), ctrl.confirmAppointment);
router.post('/', authenticate, generalLimiter, ctrl.createAppointment);
router.patch('/:id/room', authenticate, ctrl.updateAppointmentRoom);
...
router.patch('/:id/complete', authenticate, ctrl.completeAppointment);
...
router.get('/:id/messages', authenticate, ctrl.getAppointmentMessages);
router.post('/:id/messages', authenticate, ctrl.sendAppointmentMessage);
