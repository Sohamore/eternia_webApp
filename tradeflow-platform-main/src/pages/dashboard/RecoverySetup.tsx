...
const RecoverySetup = () => {
  ...
  const handleSave = async () => {
    ...
    try { await api.post("/profiles/recovery", { fragment_pairs: fragmentPairs, emoji_pattern: selectedEmojis }); setIsComplete(true); toast.success("Recovery setup complete!"); } catch (e: any) { toast.error(e.response?.data?.error || e.message); } finally { setIsSaving(false); }
  };
